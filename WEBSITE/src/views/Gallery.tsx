      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Всяко парче е уникално и изработено с любов. Разгледай нашите
            творения!
          </p>
        </div>
        ...
        {/* SEO text */}
        <div className="mt-16 max-w-3xl mx-auto text-sm text-muted-foreground leading-relaxed space-y-4">
          <p>
            В нашата галерия ще откриете разнообразие от ръчно изработени
            подаръци за бебета и деца. Всяка керамична фигура е рисувана на ръка
            с нетоксични бои, безопасни за най-малките. Клипсовете за биберон са
            изработени от сертифицирани материали и могат да бъдат
            персонализирани с името на вашето бебе.
          </p>
          <p>
            Подаръчните комплекти включват внимателно подбрани елементи, красиво
            опаковани и готови за подаряване. Независимо дали търсите подарък за
            рожден ден, кръщене или бебешко парти, при нас ще намерите нещо
            специално.
          </p>
          <p>
            Всички наши продукти са създадени в България с любов и внимание към
            детайла. Ако имате специални пожелания или искате персонализация, не
